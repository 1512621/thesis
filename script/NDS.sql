------------ Create user manage NDS---------
create user AdminNDS IDENTIFIED BY adminnds;
/
grant connect to AdminNDS;
/
grant dba to AdminNDS WITH admin option;
/
-------------CREATE GHCN_V4
...
create table GHCN_V4 (
  ...
  Flag11 varchar2(50),
    Dece numeric,
  Flag12 varchar2(50),
  primary key(id_country,WMO_station_number,year_GHCN,ELEMENT_GHCN)
)
/
...
(
  ...
  Nov numeric,
  Dece numeric,
  primary key(id_country,WMO_station_number,modifier,duplicate_flag,year_PRECIP)
)
/
